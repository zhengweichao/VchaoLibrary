package top.vchao.lib.permission.aop;
...
import top.vchao.lib.permission.PermissionRequestActivity;
...
import top.vchao.lib.permission.interf.IPermission;
import top.vchao.lib.permission.util.Utils;
...
public class PermissionAspect {
    ...
    private static final String PERMISSION_REQUEST_POINTCUT =
            "execution(@top.vchao.lib.permission.annotation.NeedPermission * *(..))";
    ...
    public void requestPermissionMethod(NeedPermission needPermission) {
        Log.e("vchao", "===========  requestPermissionMethod  ============");
    }
